      ...
      <article className='p-4 lg:max-w-[600px] lg:pt-10 '>
        ...
        <section className='flex space-x-1 py-1  pb-2 text-sm font-medium uppercase'>
          ...
          <span>
            Choose your offer:
            {quantity == 1 ? (
              <span className='text-[16px] font-semibold'> 5-Pack</span>
            ) : quantity == 2 ? (
              <span className='text-[16px] font-semibold'> 10-Pack</span>
            ) : (
              <span className='text-[16px] font-semibold'>15-Pack</span>
            )}
          </span>
        </section>
        <section className='m-auto mt-1 flex space-x-1'>
          <article
            ...
            <h2 className='font-bold'>5-Pack</h2>
            <h3 className=''>
            ...
            <span className='text-sm font-semibold'>
              £{(produit.price / 5).toFixed(2)} each
            </span>
          </article>
          ...
          <article
            ...
            <h2 className='font-bold'>10-Pack</h2>
            <h3 className=''>
            ...
            <h3 className='text-sm font-semibold'>
              £{(((produit.price * 1.5) ) / 10).toFixed(2)} each
            </h3>
          </article>
          <article
            ...
            <h2 className='font-bold'>15-Pack</h2>
            <h3 className=''>
            ...
            <span className='text-sm font-semibold '>
              £{(((produit.price * 2)) / 15).toFixed(2)} each
            </span>
          </article>
        </section>
